...
sed -i 's/DEFAULT_PACKAGES += /DEFAULT_PACKAGES += luci-app-advancedplus luci-theme-kucat luci-app-passwall2 luci-app-nikki luci-app-udpxy /g' target/linux/x86/Makefile
