...
sed -i 's/DEFAULT_PACKAGES += /DEFAULT_PACKAGES += luci-app-advancedplus luci-app-netwizard luci-app-passwall2 luci-app-mihomo luci-app-udpxy /g' target/linux/x86/Makefile
