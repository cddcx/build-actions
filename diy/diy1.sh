...
# 修改网络
sed -i "s/ucidef_set_interface_lan 'eth0'/ucidef_set_interface_lan 'eth0'
ucidef_set_interface_lan 'eth2'
ucidef_set_interface_lan 'eth3'/" package/base-files/files/etc/board.d/99-default_network
