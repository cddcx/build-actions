...
sed -i 's/DEFAULT_PACKAGES +=/DEFAULT_PACKAGES += kmod-usb-hid kmod-mmc kmod-sdhci kmod-fs-f2fs cfdisk usbutils pciutils htop lm-sensors iperf3 autocore-x86 htop lm-sensors iperf3 kmod-usb-audio ca-bundle/g' target/linux/x86/Makefile
