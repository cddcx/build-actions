...
#sed -i 's/nftables/nftables block-mount coremark kmod-nf-nathelper kmod-nf-nathelper-extra kmod-ipt-raw kmod-tun/g' include/target.mk
#sed -i 's/kmod-nft-offload/ipset ip-full default-settings curl ca-certificates/g' include/target.mk
...
sed -i 's/DEFAULT_PACKAGES +=/DEFAULT_PACKAGES += kmod-usb-hid kmod-mmc kmod-sdhci kmod-fs-f2fs cfdisk usbutils pciutils htop lm-sensors iperf3 autocore-x86 htop lm-sensors iperf3 kmod-usb-audio ca-bundle block-mount coremark kmod-nf-nathelper kmod-nf-nathelper-extra kmod-ipt-raw kmod-tun/g' target/linux/x86/Makefile
...
sed -i 's/e2fsprogs kmod-button-hotplug/e2fsprogs kmod-button-hotplug kmod-sound-hda-core kmod-sound-hda-codec-realtek kmod-sound-hda-codec-via kmod-sound-via82xx kmod-sound-hda-intel kmod-sound-hda-codec-hdmi kmod-sound-i8x0 ipset ip-full default-settings curl ca-certificates/g' target/linux/x86/Makefile
sed -i 's/grub2-bios-setup/grub2-bios-setup kmod-usb-net kmod-usb-net-asix-ax88179 kmod-usb-net-rtl8150 kmod-usb-net-rtl8152-vendor kmod-usb-net-aqc111 kmod-mlx4-core kmod-mlx5-core kmod-drm-i915 kmod-drm-amdgpu luci-app-openclash luci-app-istorex luci-app-udpxy luci-app-upnp/g' target/linux/x86/Makefile
