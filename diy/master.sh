...
sed -i 's/DEFAULT_PACKAGES +=/DEFAULT_PACKAGES += kmod-usb-hid kmod-mmc kmod-sdhci kmod-fs-f2fs cfdisk usbutils pciutils kmod-mlx4-core kmod-mlx5-core kmod-drm-i915 kmod-drm-amdgpu kmod-sound-hda-codec-hdmi kmod-sound-i8x0 kmod-usb-audio/g' target/linux/x86/Makefile
...
sed -i 's/e2fsprogs kmod-button-hotplug/e2fsprogs kmod-button-hotplug htop lm-sensors iperf3 kmod-sound-hda-intel kmod-usb-net kmod-usb-net-asix-ax88179 kmod-usb-net-rtl8150 kmod-usb-net-rtl8152-vendor kmod-usb-net-aqc111/g' target/linux/x86/Makefile
