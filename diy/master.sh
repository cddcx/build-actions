...
sed -i 's/grub2-bios-setup/grub2-bios-setup htop lm-sensors iperf3 autocore-x86 ca-bundle luci-app-openclash luci-app-istorex luci-app-udpxy luci-app-upnp/g' target/linux/x86/Makefile
