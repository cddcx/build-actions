...
sed -i 's/DEFAULT_PACKAGES += /DEFAULT_PACKAGES += luci-app-homeproxy luci-app-mihomo luci-app-passwall2 luci-app-upnp luci-app-udpxy /g' target/linux/x86/Makefile
