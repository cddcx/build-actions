...
sed -i 's/DEFAULT_PACKAGES += /DEFAULT_PACKAGES += luci-ssl px5g-mbedtls luci-app-upnp luci-app-udpxy luci-app-homeproxy luci-app-passwall2 /g' target/linux/x86/Makefile
