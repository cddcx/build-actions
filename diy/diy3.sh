...
sed -i 's/DEFAULT_PACKAGES += /DEFAULT_PACKAGES += luci-app-homeproxy luci-app-mihomo luci-app-upnp luci-app-udpxy luci-app-openclash /g' target/linux/x86/Makefile
