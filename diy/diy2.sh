...
sed -i 's/DEFAULT_PACKAGES += /DEFAULT_PACKAGES += ipset ip-full luci-app-filetransfer luci-app-ttyd luci-app-passwall2 luci-app-udpxy luci-app-upnp /g' target/linux/x86/Makefile
