...
mkdir -p feeds/packages/net/shadowsocks-libev
git clone https://github.com/sbwml/openwrt_helloworld/tree/v5/shadowsocksr-libev feeds/packages/net/shadowsocks-libev
