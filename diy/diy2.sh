...
sed -i 's/DEFAULT_PACKAGES += /DEFAULT_PACKAGES += autocore automount ipv6-helper luci-app-dockerman luci-app-diskman luci-app-passwall2 luci-app-ttyd luci-app-udpxy /g' target/linux/x86/Makefile
