...
sed -i 's/DEFAULT_PACKAGES += /DEFAULT_PACKAGES += luci-app-udpxy luci-app-upnp luci-app-v2raya /g' target/linux/x86/Makefile

## 删除
rm -rf feeds/packages/net/{v2raya,v2ray-core,xray-core}
